        ...
        <section className="banner-pages" style={{ backgroundImage: "url('assets/img/bg-home-visit.png')" }}>
          <div className="container">
            <div className="text">
              ...
              <p>Experience the convenience of consultations with doctors right in your place. With a guarantee of a clinic.</p>
                  ...
                  <div className="accordion-body">
                    <div className="list-data-faq">
                      <div className="row gy-3">
                        ...
                        <div className="col-12">
                          <p>
                            A Doctor Home Visit brings medical care to your doorstep, allowing patients to receive examinations,
                            diagnoses, prescriptions, and advice in the comfort of their own homes.
                          </p>
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              ...
                              <span>Easy access for vulnerable populations like the elderly and those with mobility issues.</span>
                            </li>
                          </ul>
                          <div className="price">
                  ...
                  <div className="accordion-body">
                    <div className="list-data-faq">
                      <div className="row gy-3">
                        ...
                        <div className="col-12">
                          <p>
                            A Nurse Home Visit brings healthcare to your door, offering personalized services like assessments,
                  ...
                  <div className="accordion-body">
                    <div className="list-data-faq">
                      <div className="row gy-3">
                        ...
                        <div className="col-12">
                          <p>
                            Child Vaccination is the administration of vaccines to protect children from diseases like measles,
                  ...
                  <div className="accordion-body">
                    <div className="list-data-faq">
                      <div className="row gy-3">
                        ...
                        <div className="col-12">
                          <p>
                            A medical check-up is a routine appointment with a healthcare professional to assess overall health
                            through vital sign measurements, a physical examination, and, if necessary, additional screenings or
                            tests.
                          </p>
                          <h6 className="title-line">
                            <span>Benefit</span>
