                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                An ancient Chinese medicine practice that involves inserting thin needles into the body at
                                specific points.
                              </p>
                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                Discover the healing touch of our osteopathy , where experienced practitioners employ gentle
                                manual techniques to restore balance and alleviate musculoskeletal issues.
                              </p>
                              <h6 className="title-line">
                                <span> Benefit </span>
                              </h6>
                              <ul className="ps-3">
                                ...
                                <li className="mb-2">
                                  ...
                                  <span>
                                    {" "}
                                    Can provide relief from tension headaches and migraines through spinal adjustments.{" "}
                                  </span>
                                </li>
                                <li className="mb-2">
                                  <h6 className="mb-1">Whole-body Wellness</h6>
                                  <span>
                                    Promotes overall well-being by addressing the interconnectedness of the musculoskeletal system
