                  ...
                  <div className="accordion-body">
                    <div className="list-data-faq">
                      <div className="row gy-3">
                        ...
                        <div className="col-12">
                          <p>
                            Praktik pengobatan Tiongkok kuno yang dengan
                            memasukan jarum tipis ke dalam tubuh pada titik
                            -titik tertentu.
                          </p>
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                {" "}
                                Meningkatkan kualitas tidur dan membantu
                                mengelola insomnia.{" "}
                              </span>
                            </li>
                            <li className="mb-2">
                        ...
                        <div className="col-12">
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                {" "}
                                Meningkatkan relaksasi, menurunkan tingkat
                                stres.{" "}
                              </span>
                            </li>
                            <li className="mb-2">
                        ...
                        <div className="col-12">
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                {" "}
                                Membantu mengurangi ketidaknyamanan dan rasa
                                sakit fisik.{" "}
                              </span>
                            </li>
                            <li className="mb-2">
                              <h6 className="mb-1">
                                Peningkatan Aliran Energi
                              </h6>
                              <span>
                                {" "}
                        ...
                        <div className="col-12">
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                {" "}
                                Memperkuat hubungan antara tubuh dan pikiran
                                untuk kesejahteraan holistik.{" "}
                              </span>
                            </li>
                          </ul>
                          <div className="price">
                  ...
                  <div className="accordion-body">
                    <div className="list-data-faq">
                      <div className="row gy-3">
                        ...
                        <div className="col-12">
                          <p>
                            Jenis meditasi yang melibatkan keadaan yang rileks
                            dan fokus pada pernapasan.
                          </p>
                          <h6 className="title-line">
                            <span> Keuntungan </span>
                          </h6>
                      ...
                      <div className="row gy-3">
                        ...
                        <div className="col-12">
                          <p>
                            ...
                            praktisi yang berpengalaman menggunakan teknik
                            lembut untuk memulihkan keseimbangan dan mengurangi
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                {" "}
                                Membantu mengatasi dan memperbaiki masalah
                                postur, mengurangi ketegangan pada tubuh.
                              </span>
                            </li>
                            <li className="mb-2">
