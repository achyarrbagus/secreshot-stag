        ...
        >
          <div className="container">
            <div className="text">
              ...
              <p>
                Experience the convenience of consultations with doctors right
                in your place. With a guarantee of a clinic.
              </p>
                  ...
                  <div className="list-data-faq">
                    <div className="row gy-3">
                      ...
                      <div className="col-12">
                        <p>
                          A Doctor Home Visit brings medical care to your
                          doorstep, allowing patients to receive examinations,
                          diagnoses, prescriptions, and advice in the comfort of
                          their own homes.
                        </p>
                        <h6 className="title-line">
                          <span>Benefit</span>
                        ...
                        <ul className="ps-3">
                          ...
                          <li className="mb-2">
                            <h6 className="mb-1">Accessibility</h6>
                            <span>
                              Easy access for vulnerable populations like the
