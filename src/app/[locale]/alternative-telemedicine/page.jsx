        ...
        >
          <div className="container">
            <div className="text">
              ...
              <p>
                Teeth whitening for enhanced appearance, secretome therapy for
                regenerative treatments, and ozone therapy for boost immune
                system.
              </p>
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                ...
                                youthful look, as tooth discoloration can be a
                                sign of aging.
                              </span>
                            </li>
                            <li className="mb-2">
                              ...
                              <span>
                                The process of teeth whitening often involves
                                professional cleaning, contributing to improved
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                A bright smile can leave a positive impression
                                in social and professional situations, fostering
                                a sense of attractiveness and friendliness.
                              </span>
                            </li>
                          </ul>
                          <div className="price">
                  ...
                  <Accordion.Body>
                    <div className="list-data-faq">
                      <div className="row gy-3">
                        ...
                        <div className="col-12">
                          <p>
                            Experience the rejuvenating benefits of Secretome, a
                            cutting-edge therapy that harnesses the power of
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                Exhibits anti-inflammatory properties, aiding in
                                immune modulation.
                              </span>
                            </li>
                            <li className="mb-2">
                          ...
                          <div className="price">
                            ...
                            <div className="d-flex ms-auto gap-1">
                              ...
                              <button
                                onClick={() =>
                                  handleBook("Secretome and Stem Cells Therapy")
                                }
                                id="secretome"
                                className="btn btn-warning fs-14 ms-auto"
                              >
                  ...
                  <Accordion.Body>
                    <div className="list-data-faq">
                      <div className="row gy-3">
                        ...
                        <div className="col-12">
                          <p>
                            Immerse yourself in the healing properties of ozone
                            therapy. Discover a holistic approach to wellness
                            with ozone therapy.
                          </p>
                          <h6 className="title-line">
                            <span>Benefit</span>
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                Proposed to have anti-inflammatory properties.
                              </span>
                            </li>
                            <li className="mb-2">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                Suggested to have antimicrobial effects that may
