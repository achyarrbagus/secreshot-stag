              ...
              <div className="accordion-item col-md-6">
                <h2 className="accordion-header">
                  <button
                    ...
                    aria-controls="collapseOne"
                  >
                    <i className="icon-menu-icon-remotetelemedicine01 me-2 fs-32"></i> General Practitioner Online Consultation
                  </button>
                </h2>
                <div id="collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div className="accordion-body">
                        ...
                        <div className="col-12">
                          ...
                          <ul className="ps-3">
                            ...
                            <li className="mb-2">
                              <h6 className="mb-1">Cost-Effective</h6>
                              <span>
                                May be more cost-efficient compared to in-person visits, considering travel expenses and time off
                                work.
                              </span>
                            </li>
                            <li className="mb-2">
                              <h6 className="mb-1">Preventive Guidance</h6>
                              <span>
                                Offers a convenient way to discuss preventive care, lifestyle changes, and general health advice
