                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                This IV drip provides a combination of
                                therapeutic components to alleviate pain,
                                nausea, and protect the gastrointestinal tract.
                                The vitamin boosters aim to enhance overall
                                well-being, boost immunity, and support various
                                metabolic processes.
                              </p>
                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                A turbocharged upgrade to our Standard Bali
                                Belly. Infused with immune-empowering zinc,
                                detoxifying glutathione, and gut-nourishing
                                probiotics, this blend is designed for
                                medical-grade resilience. Beyond addressing Bali
                                belly symptoms, it stands as a robust solution,
                                fortifying your well-being at a cellular level.
                                Immunity, detoxification, and digestive health
                                converge for your optimal vitality.
                              </p>
                              <h6 className="title-line">
                                <span> Composition </span>
                              </h6>
                          ...
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                ...
                                robust Vitamin B complex, and a dose of Vitamin
                                C. It acts to fortify the immune system, enhance
                          ...
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                ...
                                and contribute to collagen production for
                                enhanced skin health and immune system
                                resilience.
                              </p>
                              <h6 className="title-line">
                                <span> Composition </span>
                          ...
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                ...
                                functions, including antioxidant defenses,
                                immune function, wound healing, and energy
                                production. This comprehensive approach
                          ...
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                ...
                                high fever for adults through intravenous and
                                can be beneficial to restore body fluids.
                              </p>
                              <h6 className="title-line">
                                <span> Composition </span>
                              </h6>
