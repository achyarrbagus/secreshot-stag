                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                This IV drip provides a combination of therapeutic components to alleviate pain, nausea, and
                                protect the gastrointestinal tract. The vitamin boosters aim to enhance overall well-being, boost
                                immunity, and support various metabolic processes.
                              </p>
                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                A turbocharged upgrade to our Standard Bali Belly. Infused with immune-empowering zinc,
                                detoxifying glutathione, and gut-nourishing probiotics, this blend is designed for medical-grade
                                resilience. Beyond addressing Bali belly symptoms, it stands as a robust solution, fortifying your
                                well-being at a cellular level. Immunity, detoxification, and digestive health converge for your
                                optimal vitality.
                              </p>
                              <h6 className="title-line">
                                <span> Composition </span>
                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                This IV drip comprises essential electrolytes, a robust Vitamin B complex, and a dose of Vitamin
                                C. It acts to fortify the immune system, enhance metabolic function, and promote the synthesis of
                          ...
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                ...
                                comprehensive Vitamin B complex. It serves to intensify the immune response, boost energy
                                metabolism, stimulate red blood cell production, and contribute to collagen production for
                                enhanced skin health and immune system resilience.
                              </p>
                              <h6 className="title-line">
                                <span> Composition </span>
                              </h6>
                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                This potent IV drip combines electrolytes, Glutathione, Zinc, and an extensive range of vitamins
                                and minerals, including A, D, E, C, B1, B2, B6, B12, and B5. It provides a formidable immune
                                enhancement and supports various bodily functions, including antioxidant defenses, immune
                                function, wound healing, and energy production. This comprehensive approach contributes to overall
                                health and vitality.
                              </p>
                              <h6 className="title-line">
                                <span> Composition </span>
                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                Hangover infusion treatment is a quick 30-60 minute procedure to help you quickly overcome
                                hangover symptoms through hydration and a combination of vitamins and electrolytes.
                              </p>
                              <h6 className="title-line">
                                <span> Composition </span>
                              </h6>
                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                Fever Infusion treatment is a rapid recovery of high fever for adults through intravenous and can
                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                Gerd/Gastritis Infusion treatment is useful for treating inflammation in the stomach or gaster
                      ...
                      <div className="accordion-body">
                        <div className="list-data-faq">
                          <div className="row gy-3">
                            ...
                            <div className="col-12">
                              <p>
                                Iron infusion is an effective treatment for iron deficiency, the condition that causes tiredness
