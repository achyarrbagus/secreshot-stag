        ...
        <section className="banner-pages" style={{ backgroundImage: "url('assets/img/bg-home-nursing.png')" }}>
          <div className="container">
            <div className="text">
              ...
              <p>
                Receive top-notch nursing and wound care services in the comfort of your villa or hotel, from recovery support to
                        ...
                        <div className="col-12">
                          ...
                          <ul className="ps-3">
                            <li className="mb-2">
                              ...
                              <span>
                                Specialized care for faster healing, complications prevention, and improved patient well-being.
                              </span>
                            </li>
                            <li className="mb-2">
                              <h6 className="mb-1">Advanced Wound Dressing</h6>
                              <span>
                                Accelerates healing, reduces infection risks, and provides optimal conditions for tissue recovery.
                              </span>
                            </li>
                            <li className="mb-2">
                            ...
                            <li className="mb-2">
                              ...
                              <span>
                                Comprehensive care for pain management, infection prevention, and smooth rehabilitation, promoting
